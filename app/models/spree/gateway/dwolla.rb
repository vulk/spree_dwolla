...
module Spree
  class Gateway::Dwolla < Gateway
    ...
    # Permit the attributes as to follow Rails 4 amd Spree 2.3 standards
    permitted_attrs = [:preferred_dwolla_id, :preferred_key, :preferred_secret, :preferred_oauth_scope, :preferred_sandbox, :preferred_allow_funding_sources, :preferred_default_funding_source, :preferred_allow_ach, :preferred_your_oauth_token, :preferred_your_pin, :preferred_enable_debug]

    permitted_attrs.each { |attr| Spree::PermittedAttributes.source_attributes << attr }
